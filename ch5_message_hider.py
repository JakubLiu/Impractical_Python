...
*this programme could be majorly simplified by using the list.insert(,) method
...
message_out = hide(message_in=message_prep(message), names = names_list)
print('A random list of words:', '\n')
print(*message_out, sep = '\n')
